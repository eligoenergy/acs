Feature: manager processes access request
    ...
    Given I am logged in as "rcooper"
		...
		And "dengle_cnu_portal" is a request created by "dengle"
		And I am on the dashboard page
    And I follow the link for "dengle_cnu_portal"
		And I should be on the show request page for "dengle_cnu_portal"
    Then I follow the access request link for "dengle_cnu_portal"
		And I should see "Current Status: Waiting for manager"
		And I "approve" "access_request_manager_approval_attributes" "admin" permission for "dengle_cnu_portal"
    ...
    And I "deny" "access_request_manager_approval_attributes" "admin" permission for "dengle_cnu_portal"
